...
def compute_best_consultants(task_requirements, config, skill_model):
    ...
    # Get use_string_matching from config
    ...
    status_text.text("Combining scores with adaptive weights...")
    ...
    if use_learning:
        ...
        status_text.text("Auto-optimizing weights...")
    else:
                ...
                if st.session_state.task_requirements.get('job_role'):
                    ...
                    for i, (user_id, score) in enumerate(results[:5], 1):
                        ...
                        accuracy_data.append({
                            ...
                            "Match": "[OK]" if is_correct else "[NO]"
                        })
